...
export function ScalingProgressWidget({
    ...
    return (
        <div className="glass-card border-white/10 bg-white/[0.04] backdrop-blur-xl rounded-2xl p-6">
            ...
            {/* Explanation */}
            <div className="mb-6 p-3 bg-white/5 rounded-lg text-sm text-gray-400">
                    ...
                    return (
                        <div 
                            ...
                            className={`flex items-center justify-between p-3 rounded-lg ${
                                isAchieved ? 'bg-green-500/10' : isCurrent ? 'bg-indigo-500/10' : 'bg-white/5'
                            }`}
                        >
                            <div className="flex items-center gap-3">
                                {isAchieved ? (
                                    ...
                                    <Circle className={`w-5 h-5 ${isCurrent ? 'text-indigo-400' : 'text-gray-600'}`} />
                                )}
                                <div>
