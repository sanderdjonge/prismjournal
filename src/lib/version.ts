...
export const BUILD_NOTES = 'Fix light mode (PrismScore tooltip, notification/account popouts), fix notification mark-read/clear-all, fix monthly return %, add toast close button, calculator entry/SL mode';
