...
export const BUILD_NOTES = 'Exit Quality Analysis now includes trades with missing MAE data (treats NULL MAE as 0 for profitable trades); fixes ~44% of trades missing efficiency scores';
