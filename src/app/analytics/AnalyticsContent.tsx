    ...
    return (
        <div className="space-y-6 pb-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="glass-card border-border-color bg-surface-elevated backdrop-blur-xl rounded-2xl p-6 flex items-center justify-center">
                ...
                <div className="glass-card border-border-color bg-surface-elevated backdrop-blur-xl rounded-2xl p-5 flex flex-col justify-between">
                    <div>
                    ...
                    <div className="space-y-2 mt-3">
                        ...
                        <p className="text-[10px] font-bold text-text-muted italic leading-tight">
                ...
                <div className="glass-card border-border-color bg-surface-elevated backdrop-blur-xl rounded-2xl p-6">
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <p className="text-[10px] text-text-muted">By symbol</p>
                        </div>
                    ...
                    <div className="h-[250px]">
                        {symbolData.length > 0 ? (
                                        ...
                                        content={({ active, payload }) => {
                                            ...
                                            return (
                                                <div className="bg-black/90 border border-border-color rounded-lg px-3 py-2 text-[10px] font-black space-y-1">
                                                    ...
                                                    <p className="text-text-muted">Win rate: {fmtDecimals(d.winRate, 1)}%</p>
                                                </div>
                                            );
                                        }}
                                    />
                            ...
                            <div className="flex items-center justify-center h-full text-text-muted text-[10px] font-black uppercase tracking-widest">No data yet</div>
                        )}
                    </div>
                </div>
            </div>
